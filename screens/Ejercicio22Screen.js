...
export default function Ejercicio22Screen({ navigation }) {
  ...
  const irAlSiguiente = (valor) => {
    guardarRespuesta(21, valor); // ✅ Guardar A22
    console.log(`Respuesta A22: ${valor}`);
    navigation.navigate('Ejercicio23');
  };

  const handleSuspender = () => {
    guardarRespuesta(21, 'SP'); // ✅ A22 = SP
    suspenderPrueba();          // ✅ A23–A25 = SP
    setTimeout(() => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.backButton}>
        <TouchableOpacity
          ...
          onLongPress={() => navigation.navigate('Ejercicio21')}
          delayLongPress={2000}
        >
      ...
      <View style={styles.filaInferior}>
        ...
        <View style={styles.tituloRS}>
          <Text style={styles.titulo}>Ejercicio A22</Text>
          <TouchableOpacity
