...
export default function Ejercicio19Screen({ navigation }) {
  ...
  const irAlSiguiente = (valor) => {
    guardarRespuesta(18, valor); // ✅ A19 → índice 18
    console.log(`Respuesta A19: ${valor}`);
    navigation.navigate('Ejercicio20');
  };

  const handleSuspender = () => {
    guardarRespuesta(18, 'SP'); // ✅ A19 = SP
    suspenderPrueba(); // ✅ A20–A25 = SP
    setTimeout(() => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.backButton}>
        <TouchableOpacity
          ...
          onLongPress={() => navigation.navigate('Ejercicio18')}
          delayLongPress={2000}
        >
      ...
      <View style={styles.filaInferior}>
        ...
        <View style={styles.tituloRS}>
          <Text style={styles.titulo}>Ejercicio A19</Text>
          <TouchableOpacity
