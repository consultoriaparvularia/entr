...
export default function Ejercicio12Screen({ navigation }) {
  ...
  const irAlSiguiente = (valor) => {
    guardarRespuesta(11, valor); // Índice 11 = A12
    console.log(`Respuesta A12: ${valor}`);
    navigation.navigate('Ejercicio13');
  };

  const handleSuspender = () => {
    guardarRespuesta(11, 'SP');
    suspenderPrueba();
    setTimeout(() => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.backButton}>
        <TouchableOpacity
          ...
          onLongPress={() => navigation.navigate('Ejercicio11')}
          delayLongPress={2000}
        >
      ...
      <View style={styles.filaInferior}>
        ...
        <View style={styles.tituloRS}>
          <Text style={styles.titulo}>Ejercicio A12</Text>
          <TouchableOpacity
