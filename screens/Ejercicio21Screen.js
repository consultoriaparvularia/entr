...
export default function Ejercicio21Screen({ navigation }) {
  ...
  const irAlSiguiente = (valor) => {
    guardarRespuesta(20, valor); // ✅ A21 = índice 20
    console.log(`Respuesta A21: ${valor}`);
    navigation.navigate('Ejercicio22');
  };

  const handleSuspender = () => {
    guardarRespuesta(20, 'SP'); // ✅ A21 = SP
    suspenderPrueba(); // ✅ A22–A25 = SP
    setTimeout(() => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.backButton}>
        <TouchableOpacity
          ...
          onLongPress={() => navigation.navigate('Ejercicio20')}
          delayLongPress={2000}
        >
      ...
      <View style={styles.filaInferior}>
        ...
        <View style={styles.tituloRS}>
          <Text style={styles.titulo}>Ejercicio A21</Text>
          <TouchableOpacity
